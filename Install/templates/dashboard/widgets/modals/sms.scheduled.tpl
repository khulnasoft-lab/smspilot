        ...
        <div class="modal-body">
            <div class="form-row">
                <div class="form-group col-12">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="eg. Daily Message">
                </div>
                ...
                <div class="form-group col-12">
                    <div class="form-group">
                        <label>{lang_form_schedule_numbers}</label>
...
"></textarea>
                ...
                <div class="form-group col-6">
                    <label>{lang_form_schedule_repeat}</label>
        ...
        <div class="modal-footer">
            <button type="submit" class="btn btn-lg btn-primary btn-block">
                <i class="la la-clock la-lg"></i> Schedule
            </button>
        </div>
    </div>
</form>