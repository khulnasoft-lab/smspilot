        ...
        <div class="modal-body">
            <div class="form-row">
                ...
                <div class="form-group col-12">
                    ...
                    <input type="text" name="email" class="form-control" placeholder="eg. user@mail.com" value="{$data.user.email}">
                </div>
                
                <div class="form-group col-12">
                    <label>{lang_form_password}</label>
                    <input type="text" name="password" class="form-control" placeholder="{lang_form_password_leave}">
                </div>
