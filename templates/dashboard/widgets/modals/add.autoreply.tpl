        ...
        <div class="modal-body">
            <div class="form-row">
                <div class="form-group col-12">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="eg. Auto Respond">
                </div>
                ...
                <div class="form-group col-12">
                    ...
                    <textarea name="keywords" class="form-control" placeholder="eg. thank you, okay, subscribe, yes"></textarea>
                </div>

                <div class="form-group col-12">
                    <label>{lang_form_autoreply_message}</label>
                    <textarea name="message" class="form-control" rows="5" placeholder="eg. Your reply message here, shortcodes accepted"></textarea>
                </div>
