        ...
        <div class="modal-body">
            <div class="form-row">
                <div class="form-group col-6">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="eg. Korean">
                </div>
                ...
                <div class="form-group col-6">
                    ...
                    <select name="iso" class="form-control" data-live-search="true">
                        ...
                        <option value="{$country@key}" data-tokens="{strtolower($country)}" {if $country@key eq "KR"}selected{/if}>{$country@key}</option>
                        {/foreach}
                    </select>
                </div>
