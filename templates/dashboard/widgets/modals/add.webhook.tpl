        ...
        <div class="modal-body">
            <div class="form-row">
                <div class="form-group col-12">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="eg. {lang_form_webhookname_placeholder}">
                </div>

                <div class="form-group col-12">
                    <label>{lang_form_webhookurl}</label>
                    <input type="text" name="url" class="form-control" placeholder="eg. https://yourdomain.com/reply.php">
                </div>
