...
require([
    ...
    'locales',
    'handlebarsExtended',
    api_template + '/api_project.js',
    api_template + '/api_data.js',
    'prettify',
    'utilsSampleRequest',
    'semver',
    'webfontloader',
    ...
    function initDynamic() {
        // Bootstrap popover
        $('button[data-toggle="popover"]').popover().on("click", function(e) {
            e.preventDefault();
        });
    ...
    if (apiProject.template.aloneDisplay) {
        ...
        if (hashVal != null && hashVal.length !== 0) {
            $("." + hashVal.slice(1) + "-init").trigger("click");
        }
    }
    ...
    $(document).keyup(function(e) {
      if (e.keyCode === 27) $('span.search-reset').trigger("click");
    });
    ...
    function loadGoogleFontCss() {
        WebFont.load({
            ...
            google: {
                families: ['Rubik:n4,n5,n7', 'Source Code Pro']
            }
        });
    }
